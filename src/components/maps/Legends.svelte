            ...
            {#if X.check}
                {#if innerWidth > 640}
                    ...
                    >
                        {#if (X.type != "point")}
                            <div class="h-5 w-5">
                                <div class="relative checkbox align-middle mx-1 rounded-full" style="--theme-color: {X.color}; background-color: var(--theme-color);"></div>
                            </div>
                        {:else}
                            <div class="h-5 w-5">
                        ...
                        <p class="float-right overflow-hidden">{X.name}</p>
                    </label>
                {:else}
                    <label 
                        ...
                        style="--theme-color: {X.color}; border-color: var(--theme-color);"
                    >
